...
**Since version 4.0.0**, the default monitor commands use `wlr-randr` for Wayland, which is the default display server on Raspberry Pi OS Bookworm (2023) and newer.
