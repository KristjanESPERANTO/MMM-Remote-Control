...
> **Since v4.0.0:** The default monitor commands use `wlr-randr` for Wayland (Raspberry Pi OS Bookworm+). For older systems with X11 or `vcgencmd`, see the [Monitor Control Guide](docs/guide/monitor-control.md).
